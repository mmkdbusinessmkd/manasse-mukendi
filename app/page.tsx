...
const projects = [
  { name: "Nom du projet", client: "CLIENT À RENSEIGNER", type: "Social Media", sector: "Secteur", mission: "Mission à renseigner", result: "Résultat à renseigner", color: "lime" },
  { name: "Nom du projet", client: "CLIENT À RENSEIGNER", type: "Branding", sector: "Secteur", mission: "Mission à renseigner", result: "Résultat à renseigner", color: "blue" },
  { name: "Nom du projet", client: "CLIENT À RENSEIGNER", type: "Campagnes", sector: "Secteur", mission: "Mission à renseigner", result: "Résultat à renseigner", color: "sand" },
  { name: "Nom du projet", client: "CLIENT À RENSEIGNER", type: "Communication", sector: "Secteur", mission: "Mission à renseigner", result: "Résultat à renseigner", color: "ink" },
  { name: "Nom du projet", client: "CLIENT À RENSEIGNER", type: "Publicité", sector: "Secteur", mission: "Mission à renseigner", result: "Résultat à renseigner", color: "coral" },
  { name: "Nom du projet", client: "CLIENT À RENSEIGNER", type: "Social Media", sector: "Secteur", mission: "Mission à renseigner", result: "Résultat à renseigner", color: "lime" },
];

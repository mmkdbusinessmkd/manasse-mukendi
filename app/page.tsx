...
const services = [
  ["01", "Conseil en communication digitale", "Clarifier vos enjeux, identifier les priorités et transformer vos objectifs en décisions concrètes."],
  ["02", "Stratégie digitale", "Définir un positionnement, des messages et une direction claire pour votre communication."],
  ["03", "Stratégie Social Media", "Construire une présence cohérente, régulière et adaptée aux usages de votre audience."],
  ["04", "Création de contenu", "Transformer vos idées, vos offres et vos actualités en contenus utiles, lisibles et engageants."],
  ["05", "Pilotage des réseaux sociaux", "Organiser les prises de parole, animer la communauté et maintenir la cohérence dans le temps."],
  ["06", "Publicité digitale", "Accélérer votre visibilité et toucher les bonnes personnes avec un budget maîtrisé."],
];
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="accueil"><div className="hero-copy"><p className="eyebrow light">MANASSÉ MUKENDI <span>/</span> KINSHASA, RDC</p><p className="positioning">Consultant en communication digitale <span>/</span> Social Media Manager</p><h1><span className="headline-lead">La communication</span> qui <em>déplace</em> les marques.</h1><p className="intro">J’aide les entreprises à clarifier leur positionnement, structurer leur communication digitale et construire une présence cohérente sur les réseaux sociaux.</p><div className="actions"><a className="button white" href="#services">Découvrir mon accompagnement <BrandGlyph/></a><a className="button button-ghost" href="#contact">Parler de votre projet <span className="button-dot" aria-hidden="true"></span></a></div></div><div className="orbit" aria-hidden="true"><div className="orbit-ring"></div><div className="orbit-core"><span>digital</span><strong>impact</strong></div><span className="tag t1">STRATÉGIE</span><span className="tag t2">SOCIAL</span><span className="tag t3">CONTENU</span><span className="dot d1"></span><span className="dot d2"></span></div><div className="hero-foot"><span>Conseil · Stratégie · Social Media</span><span>Disponible pour des projets en RDC et à l’international <b>●</b></span></div></section>

    <section className="section services" id="services"><div className="section-head"><p className="eyebrow">01 / ACCOMPAGNEMENT</p><h2>Ce que j’apporte<br/>à votre communication.</h2></div><div className="service-grid">{services.map(([n,t,d]) => <article className="service" key={n}><span>{n}</span><h3>{t}</h3><p>{d}</p><BrandGlyph className="card-glyph"/></article>)}</div></section>

    <section className="about" id="a-propos"><div className="portrait"><div className="portrait-photo" role="img" aria-label="Portrait créatif de Manassé Mukendi, consultant en communication digitale"></div><div className="portrait-note">MANASSÉ<br/>MUKENDI <BrandGlyph className="outline"/></div></div><div className="about-copy"><p className="eyebrow">02 / À PROPOS</p><h2>Je ne commence jamais<br/>par <em>publier.</em></h2><div className="bio editorial-bio"><p className="about-lead">Je commence par comprendre.</p><p className="about-role">Consultant en communication digitale et Social Media Manager basé à Kinshasa, j’accompagne les entreprises qui veulent rendre leur communication plus claire, cohérente et performante.</p><p>Votre marque, vos objectifs, votre audience, votre positionnement et la perception que vous souhaitez construire guident chaque recommandation.</p><p>C’est cette compréhension qui me permet ensuite de proposer une communication utile et pensée pour durer.</p></div></div></section>

...
const services = [
  ["01", "Conseil en communication digitale", "Faire émerger les vrais enjeux et transformer vos objectifs en priorités de communication claires."],
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="accueil"><div className="hero-copy"><p className="eyebrow light">MANASSÉ MUKENDI <span>/</span> BASÉ À KINSHASA</p><p className="positioning">Consultant en communication digitale <span>/</span> Social Media Manager</p><h1><span className="headline-lead">La communication</span> qui <em>déplace</em> les marques.</h1><p className="intro">J’aide les entreprises à mieux structurer leur image, leur communication et leur présence digitale pour être mieux comprises, mieux perçues et mieux choisies.</p><div className="actions"><a className="button white" href="#services">Découvrir mes services <BrandGlyph/></a><a className="button button-ghost" href="#contact">Parler de votre projet <span className="button-dot" aria-hidden="true"></span></a></div></div><div className="orbit" aria-hidden="true"><div className="orbit-ring"></div><div className="orbit-core"><span>digital</span><strong>impact</strong></div><span className="tag t1">STRATÉGIE</span><span className="tag t2">SOCIAL</span><span className="tag t3">CONTENU</span><span className="dot d1"></span><span className="dot d2"></span></div><div className="hero-foot"><span>Conseil · Stratégie · Social Media</span><span>RDC · AFRIQUE · INTERNATIONAL <b>●</b></span></div></section>

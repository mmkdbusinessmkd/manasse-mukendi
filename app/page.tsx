...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero" id="accueil"><div className="hero-copy"><p className="eyebrow light">MANASSÉ MUKENDI <span>/</span> SOCIAL MEDIA MANAGER</p><p className="hero-positioning">Marketing et communication digitale</p><h1><span className="headline-lead">La communication</span> qui <em>déplace</em> les marques.</h1><p className="intro">Une image claire. Des contenus qui comptent. Une présence digitale qui donne envie de vous choisir.</p><div className="actions"><a className="button white" href="#contact">Parler de mon projet <BrandGlyph/></a><a className="button button-ghost" href="#services">Découvrir mes services <span className="button-dot" aria-hidden="true"></span></a></div></div><div className="orbit" aria-hidden="true"><div className="orbit-ring"></div><div className="orbit-core"><span>digital</span><strong>impact</strong></div><span className="tag t1">STRATÉGIE</span><span className="tag t2">SOCIAL</span><span className="tag t3">CONTENU</span><span className="dot d1"></span><span className="dot d2"></span></div><div className="hero-foot"><span>Marketing · Communication · Social Media</span><span>PROJETS LOCAUX &amp; INTERNATIONAUX <b>●</b></span></div></section>
